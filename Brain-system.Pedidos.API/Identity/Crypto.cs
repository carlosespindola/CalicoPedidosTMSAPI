...
namespace Auth.API.Identity
{

    public class Encrypt
    {
        private const string _encKey = "8A9BE8FD67AF6979E7D20198CFEA50DD3D3799C77AF2B72F";

        public static string EncryptString(string password)
        {
            return Crypto.Encrypt(password, _encKey);
        }

        public static string DecryptString(string password)
        {
            return Crypto.Decrypt(password, _encKey);
        }
    }
